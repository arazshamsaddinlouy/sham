...
if(placeArray){_callLine=`${arr1_type} A[] = coderbyteInternalStdinFunction(stdin);
  int arrLength = sizeof(A) / sizeof(*A);
  ${_ct}(A, arrLength);
  return 0;`}else{_callLine=`${_ct}(coderbyteInternalStdinFunction(stdin));
  return 0;`}
return `
#include <stdio.h> 
#include <string.h>
...
if(placeArray){_callLine=`${arr1_type} A[] = coderbyteInternalStdinFunction(stdin);
  ...
  return 0;`}else{_callLine=`cout << ${_ct}(coderbyteInternalStdinFunction(stdin));
  return 0;`}
return `
#include <iostream>
#include <string>
